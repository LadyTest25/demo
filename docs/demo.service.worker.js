...
/** @type {string} */
const CACHE_VERSION = '1757890523|9211517098';
/** @type {string} */
const CACHE_PREFIX = 'ASCII Cert Quest-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["demo.html","demo.js","demo.offline.html","demo.icon.png","demo.apple-touch-icon.png","demo.audio.worklet.js","demo.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["demo.wasm","demo.pck"];
